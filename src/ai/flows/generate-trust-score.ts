...
structuralScore: A float between 0.0 and 1.0.
signatureScore: A float between 0.0 and 1.0.
typographicalScore: A float between 0.0 and 1.0.
TrustScore: A final, weighted-average confidence score calculated as (0.4 * structuralScore) + (0.4 * signatureScore) + (0.2 * typographicalScore).
summary: A brief, one-sentence summary of your findings (e.g., "High confidence in authenticity." or "Detected anomalies in signature and layout.").
flags: An array of strings describing any detected issues (e.g., []).
